...
def configuration(args: argparse.Namespace) -> Tuple[Dict[str, str], List[str]]:
    values = {
        ...
        "RINBAM_ADMIN_E2E_PROTECTED_PATH": os.environ.get("RINBAM_ADMIN_E2E_PROTECTED_PATH", "/admin"),
        "RINBAM_ADMIN_E2E_PROTECTED_API_PATH": os.environ.get("RINBAM_ADMIN_E2E_PROTECTED_API_PATH", "/api/admin/audit"),
        "RINBAM_ADMIN_E2E_SENSITIVE_PATH": os.environ.get("RINBAM_ADMIN_E2E_SENSITIVE_PATH", "/admin"),
