...
- Baseline: `c051981529dab6809a64403d46ae4436370bb8a6`
- Image: `rinbam-media-resolver:pot-node-final`
...
| `git diff --check` | PASS |
| `python3 -m unittest tests.test_media_resolver_backend` | 56 passed, 0 failed |
...
| Container memory after final non-root smoke | 194.5 MiB observed, below the Railway Free 512 MB limit |
...
capacity guarantee. Production behavior remains unverified until the committed
image deploys on Railway Free and the public `/resolve` and `/proxy` smokes pass.
