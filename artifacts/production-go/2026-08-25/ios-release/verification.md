...
- Exact version `1.0.19 (21)` was not operated through Appium/WebDriverAgent on a physical iPhone. Archive/export/upload success is not physical-device UI proof.
