...
| iOS | CURRENT_SOURCE_CHATGPT_COMPOSER_PASS / DISTRIBUTION_BLOCKED | Current source `com.mibu.codebridge.ios`, `1.0.15` build `16`, was operated on iPhone 12 UDID `00008101-00066D96340A001E` with Appium/WDA through tag selection, 3-item preview, confirmation, ZIP creation, iOS share-sheet `ChatGPT` selection, and visible ZIP attachment in ChatGPT bundle `com.openai.chat`. The question field was empty and no send action was performed. No Apple Distribution identity is installed. Evidence: `artifacts/device-verification/2026-07-19-ios-ch13/`. |
