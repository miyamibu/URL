...
Current source baseline is Android `1.0.17 (versionCode=21)` and iOS `1.0.17 (build=19)`. The official App Store URL directly confirmed public `1.0.17` on 2026-08-13; do not use stale search summaries or the historical `1.0.11` state as current proof.
...
| Privacy policy URL | `https://miyamibu.xyz/privacy/` | `https://miyamibu.xyz/privacy/` | PUBLIC_VERIFIED: current Vercel deployment `dpl_52Tc5XaiiLeV9F1EkxTLPXssqRmq`; `scripts/verify_public_web_release.sh` passes. |
